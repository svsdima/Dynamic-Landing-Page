...
/* harmony import */ var _time_of_day__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./time-of-day */ "./src/js/time-of-day.js");
/* harmony import */ var _weather__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./weather */ "./src/js/weather.js");


document.addEventListener('DOMContentLoaded', function () {
  Object(_time_of_day__WEBPACK_IMPORTED_MODULE_0__["default"])();
  Object(_weather__WEBPACK_IMPORTED_MODULE_1__["default"])();
});

/***/ }),

/***/ "./src/js/time-of-day.js":
/*!*******************************!*\
  !*** ./src/js/time-of-day.js ***!
  \*******************************/
...
var timeOfDay = function timeOfDay() {
  // DOM Elements
...
/* harmony default export */ __webpack_exports__["default"] = (timeOfDay);
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      var proxy = 'https://cors-anywhere.herokuapp.com/',
          api = "".concat(proxy, "api.openweathermap.org/data/2.5/weather?q=Moscow&lang=ru&appid=c15ebc9ffd7cab5cd613d4363fccbca2");
      fetch(api).then(function (response) {
        ...
        var weather = data.weather,
            main = data.main,
            name = data.name; // Set DOM Elements from API
