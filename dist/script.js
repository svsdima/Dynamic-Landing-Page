...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var time = document.getElementById('time'),
      ...
      focus = document.getElementById('focus'); //  Show Time
  ...
  function showTime() {
    ...
    time.innerHTML = "".concat(hour, "<span>:</span>").concat(addZero(min), "<span>:</span>").concat(addZero(seconds));
    date.innerHTML = "".concat(addZero(day), "<span> </span>").concat(month, "<span> </span>").concat(year);
    week.innerHTML = "".concat(dayWeek);
